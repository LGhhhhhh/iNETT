...
train_set_data = np.load(path1 + 'train_set_data.npy')
train_true_image = np.load(path1 + 'train_true_image.npy')

test_set = np.load(path1 + 'validation_set.npy')
test_label_set = np.load(path1 + 'validation_set_label.npy')
test_set_data = np.load(path1 + 'validation_set_data.npy')
test_true_image = np.load(path1 + 'validation_true_image.npy')
